...
$postOne = new TelegraphText('Oleg', 'test.txt');

$postOne->storeText('Классное кино', 'В бой идут одни старики');

echo $postOne->loadText() . PHP_EOL;

$postOne->editText('Хорошее кино', 'Девчата');
